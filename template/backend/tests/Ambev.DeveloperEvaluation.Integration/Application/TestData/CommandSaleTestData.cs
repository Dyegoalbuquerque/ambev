...
public class CommandSaleTestData : Faker<CreateSaleCommand>
{
    public CommandSaleTestData(int countItens = 0)
    {
        ...
        RuleFor(s => s.Products, f =>  Enumerable.Range(0, countItens).Select(_ => new CommandSaleItemTestData().Generate()).ToList());
    }
}
